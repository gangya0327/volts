<template>
  <div id="app">
    <ul class="navbarUl">
      ...
      <li>
        <router-link to='/firstclass'>第一课</router-link>
      </li>
      <!-- <li>
      ...
      <li>
        <router-link to='/learnES6_1'>学习ES6_1</router-link>
      </li>
      <li>
        <router-link to='/learnES6_2'>学习ES6_2</router-link>
      </li>
      <li>
        <router-link to='/learnES6_3'>学习ES6_3</router-link>
      </li>
      <li>
